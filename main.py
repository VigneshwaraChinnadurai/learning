...
react_prompt_with_format_instructions = PromptTemplate(
    ...
    input_variables=["input", "agent_scratchpad", "tool"],
...
def main2():
    result = chain.invoke(
        input={
            "input": "Search for 10 job posting for an AI engineer using langchain in Bengaluru area on LinkedIn and list their details."
        }
    )
    print(result)
